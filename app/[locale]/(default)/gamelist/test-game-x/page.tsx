export default function TestGameXPage() {
  return (
    <>
      <div className="bg-black min-h-screen p-8 space-y-8">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 text-gray-100">
          ...
          <section className="bg-gray-800 p-6 rounded-xl">
            <h2 className="text-2xl font-bold mb-4 text-sky-400">⊗ Test Game X</h2>
            <p className="mb-4">This is a math game embedded via iframe. Enjoy the gameplay and challenge yourself!</p>
          </section>
          ...
          <section className="bg-gray-800 p-6 rounded-xl">
            ...
            <dl className="space-y-4">
              ...
              <dd className="text-sm text-gray-300 ml-4">This game belongs to the math category.</dd>
            </dl>
          </section>
        </div>
      </div>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "VideoGame",
        "name": "Test Game X",
        "url": "/gamelist/test-game-x",
        "image": "/images/test-game-x-cover.jpg",
        "description": "A math game: Test Game X.",
