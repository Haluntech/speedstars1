export default function sprunkfruityPage() {
  return (
    <>
      <div className="bg-black min-h-screen p-8 space-y-8">
        ...
        <div className="mx-auto max-w-7xl h-[70vh] bg-gray-900 rounded-xl overflow-hidden">
          <iframe
            src="https://incrediboxfruity.eratogame.com"
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 text-gray-100">
          ...
          <section className="bg-gray-800 p-6 rounded-xl">
            <h2 className="text-2xl font-bold mb-4 text-sky-400">⊗ sprunkfruity</h2>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "VideoGame",
        "name": "sprunkfruity",
        "url": "/gamelist/sprunkfruity",
        "image": "/images/sprunkfruity-cover.jpg",
        "description": "A sprunki game: sprunkfruity.",
