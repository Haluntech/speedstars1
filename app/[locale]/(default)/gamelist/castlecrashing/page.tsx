    ...
    return (
      <div className="bg-black min-h-screen p-8 space-y-8">
        ...
        <div className="mx-auto max-w-7xl h-[70vh] bg-gray-900 rounded-xl overflow-hidden">
          <iframe
            src="https://uploads.ungrounded.net/alternate/1454000/1454623_alternate_130359_r213.zip/?NewgroundsAPI_PublisherID=1&NewgroundsAPI_SandboxID=683b2f640fb68&NewgroundsAPI_SessionID=&NewgroundsAPI_UserName=%26lt%3Bdeleted%26gt%3B&NewgroundsAPI_UserID=0&ng_username=%26lt%3Bdeleted%26gt%3B"
