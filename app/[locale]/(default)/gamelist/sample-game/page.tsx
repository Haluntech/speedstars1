  ...
  return (
    <>
      <div className="bg-black min-h-screen p-8 space-y-8">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 text-gray-100">
          ...
          <section className="bg-gray-800 p-6 rounded-xl">
            <h2 className="text-2xl font-bold mb-4 text-sky-400">⊗ Sample Game</h2>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "VideoGame",
        "name": "Sample Game",
        "url": "/gamelist/sample-game",
        "image": "/images/sample-game-cover.jpg",
        "description": "A puzzle game: Sample Game.",
