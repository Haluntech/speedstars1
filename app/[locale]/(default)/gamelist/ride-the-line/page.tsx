    ...
    return (
      <div className="bg-black min-h-screen p-8 space-y-8">
        ...
        <div className="mx-auto max-w-7xl h-[70vh] bg-gray-900 rounded-xl overflow-hidden">
          <iframe
            src="https://html-classic.itch.zone/html/13496487/dist/index.html"
          ...
          <section className="bg-gray-800 p-6 rounded-xl">
            ...
            <div className="space-y-4">
              <div className="bg-gray-700 p-4 rounded-lg">
                <h3 className="font-semibold mb-2">Balance Principle</h3>
                <p>Keep your balance and careful not to hit your head!<br/>
                Use the 'A' & 'D' keys to move<br/>
                Use the 'LEFT' & 'RIGHT' arrows to balance</p>
              </div>
